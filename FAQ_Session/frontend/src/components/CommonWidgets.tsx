...
export const StatusBadge: React.FC<StatusBadgeProps> = ({ status }) => {
  const getStatusStyles = (stat: string) => {
    switch (stat) {
      case 'OPEN':
        return { bg: 'bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-700', label: 'Open' };
      case 'ANSWERED':
        return { bg: 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-700', label: 'Answered' };
      case 'RESOLVED':
        return { bg: 'bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-700', label: 'Resolved' };
      default:
...
export const OfficialBadge: React.FC<OfficialBadgeProps> = ({ type }) => {
  if (type === 'official') {
    return (
      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 text-[11px] font-semibold bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-700 rounded-full">
        <ShieldCheck size={12} className="text-blue-600 dark:text-blue-400 fill-blue-100 dark:fill-blue-900" />
  ...
  return (
    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 text-[11px] font-semibold bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-700 rounded-full">
      <Award size={12} className="text-emerald-600 dark:text-emerald-400 fill-emerald-100 dark:fill-emerald-900" />
