...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <motion.aside
        className={`fixed top-0 left-0 bottom-0 z-40 flex flex-col w-[260px] bg-slate-50 dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 p-5 transition-transform md:translate-x-0 ${
      ...
      >
        {/* App Branding */}
        <div className="flex items-center gap-3 py-3 mb-6 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl p-3 shadow-sm relative overflow-hidden">
          <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xl font-bold">
            🚀
          </div>
          <div>
        ...
        <div className="mt-auto pt-4">
          <div className="p-4 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl shadow-sm flex flex-col items-center text-center">
