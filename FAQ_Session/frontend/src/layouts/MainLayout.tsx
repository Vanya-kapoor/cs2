          ...
          <div className="w-96 max-w-[calc(100vw-2rem)] border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-2xl z-50 flex flex-col rounded-2xl mb-4 overflow-hidden" style={{ maxHeight: 'calc(100vh - 120px)' }}>
            ...
            <div className="bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 p-4 flex justify-between items-center">
              ...
              <button 
                ...
                className="p-1.5 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition-colors cursor-pointer"
              >
                <X size={16} />
              </button>
            </div>
            ...
            <div className="flex-1 min-h-[220px] max-h-[380px] overflow-y-auto p-4 space-y-3 bg-slate-50/50 dark:bg-slate-900/30 scrollbar-thin">
            ...
            <form onSubmit={handleSend} className="border-t border-slate-200 dark:border-slate-700 p-3 bg-white dark:bg-slate-800 flex gap-2">
              <input
                ...
                disabled={isLoading}
                className="flex-1 border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-2 text-sm font-normal outline-none bg-slate-50 dark:bg-slate-700 placeholder:text-slate-400 dark:placeholder:text-slate-500 text-slate-800 dark:text-slate-100 focus:bg-white dark:focus:bg-slate-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
              />
              <button
                type="submit"
